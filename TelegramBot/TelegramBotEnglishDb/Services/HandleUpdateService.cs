...
namespace DemoDotnetBot.Services
{
    public class HandleUpdateService
    {
        ...
        public async Task EchoAsync(Update update)
        {
            ...
            {
                UpdateType.Message => BotOnMessageRecieved(update.Message!),// added !
                UpdateType.CallbackQuery => BotOnCallBackQueryRecieved(update.CallbackQuery!),// added !
        ...
        {
            await _botClient.SendTextMessageAsync(
                chatId: callbackQuery.Message!.Chat.Id,// added !
